        ...
        require("which-key").add(
            {
                ...
                { "<leader>flx", "<cmd>Telescope diagnostics bufnr=0<CR>",                                                                                       desc = "Diagnostics" },
                ...
                -- { "<leader>ft",  "<cmd>TodoTelescope cwd=current<CR>",                                                                                           desc = "Todo: current file" },
                { "<leader>fT",  "<cmd>TodoTelescope<CR>",                                                                                                       desc = "Todo: all files" },
